...
extension = ".html"
pathName = "docs/"
text_to_search = "http://localhost:2368/"
replacement_text = "https://shalutharajapakshe.github.io/"
...
for dirpath, dirnames, filenames in os.walk(pathName):
    for filename in [f for f in filenames if f.endswith(extension)]:
        ...
        replace_file(tempFileName, ".JPGPG", ".JPG")
        replace_file(tempFileName, ".JPGJPG", ".JPG")
        replace_file(tempFileName, ".jpegpeg", ".jpeg")
        replace_file(tempFileName, ".jpegeg", ".jpeg")
        replace_file(tempFileName, ".jpegg", ".jpeg")
...
fromDirectory = "/home/blog/myBlog/ghost_admin/content/images/"
